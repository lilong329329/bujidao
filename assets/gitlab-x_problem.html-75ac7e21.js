import{_ as a,W as t,X as d,Z as n,$ as e,a0 as s,Y as l,D as r}from"./framework-4b7e9ff4.js";const c={},o=l(`<h1 id="问题集锦" tabindex="-1"><a class="header-anchor" href="#问题集锦" aria-hidden="true">#</a> 问题集锦</h1><h2 id="_1-push-提交异常" tabindex="-1"><a class="header-anchor" href="#_1-push-提交异常" aria-hidden="true">#</a> 1. push 提交异常</h2><p>push 提交时出现fatal: The remote end hung up unexpectedly异常</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>localhost:android zhangshengzhong$ git push --set-upstream http://gitlab.isture.com/zsz/android-gitbook.git master
