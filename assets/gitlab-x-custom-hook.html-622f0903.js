import{_ as o,W as t,X as l,Z as e,$ as s,a0 as a,Y as i,D as r}from"./framework-4b7e9ff4.js";const p={},c=i(`<h1 id="gitlab配置custom-hook" tabindex="-1"><a class="header-anchor" href="#gitlab配置custom-hook" aria-hidden="true">#</a> gitlab配置custom hook</h1><h2 id="_1-具体步骤" tabindex="-1"><a class="header-anchor" href="#_1-具体步骤" aria-hidden="true">#</a> 1. 具体步骤</h2><h3 id="_1-1-设置custom-hooks路径" tabindex="-1"><a class="header-anchor" href="#_1-1-设置custom-hooks路径" aria-hidden="true">#</a> 1.1 设置custom_hooks路径</h3><p>修改 gitlab 中的<code>vi /etc/gitlab/gitlab.rb</code></p><p>增加 custom_hooks_dir 路径：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>gitlab_shell[&#39;custom_hooks_dir&#39;] = &quot;/opt/gitlab/embedded/service/gitlab-shell/hooks&quot;
