import{_ as e,W as i,X as n,Y as d}from"./framework-4b7e9ff4.js";const s={},a=d(`<h1 id="es实战-删除历史索引" tabindex="-1"><a class="header-anchor" href="#es实战-删除历史索引" aria-hidden="true">#</a> ES实战 - 删除历史索引</h1><h2 id="_1-脚本" tabindex="-1"><a class="header-anchor" href="#_1-脚本" aria-hidden="true">#</a> 1. 脚本</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>#!/bin/bash
