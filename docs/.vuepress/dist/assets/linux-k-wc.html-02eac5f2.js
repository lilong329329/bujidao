import{_ as e,W as a,X as d,Y as i}from"./framework-4b7e9ff4.js";const s={},c=i(`<h1 id="wc统计命令" tabindex="-1"><a class="header-anchor" href="#wc统计命令" aria-hidden="true">#</a> wc统计命令</h1><h2 id="_1-简介" tabindex="-1"><a class="header-anchor" href="#_1-简介" aria-hidden="true">#</a> 1 简介</h2><p>统计文件里面有多少单词，多少行，多少字符。</p><h2 id="_2-wc语法" tabindex="-1"><a class="header-anchor" href="#_2-wc语法" aria-hidden="true">#</a> 2 wc语法</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code> wc [-lwm]
